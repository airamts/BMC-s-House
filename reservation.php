...
if(isset($_SESSION['user_id'])){
    echo '<p class="text-white bg-dark text-center">Hello '. $_SESSION['username'] .', Create your reservation here!</p>';
    ...
    <div class="signup-form">
        <form action="includes/reservation.inc.php" method="post">
            ...
            <label>Enter Date</label>
                ...
                <small class="form-text text-muted">Choose a reservation date</small>
            </div>
            <div class="form-group">
		    <label>Enter Time Zone</label>
                <select class="form-control" name="time" placeholder="Time" required="required">
                ...
                <small class="form-text text-muted">Choose a reservation time</small>
            </div>
            <div class="form-group">
