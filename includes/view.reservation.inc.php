            ...
            <table class="table table-hover table-responsive-sm text-center">
                <thead>
                    <tr>
                        ...
                        <th class="table-danger" scope="col" colspan="2"></th>
                    </tr>
                </thead> ';
                ...
                <tbody>
                    ...
                    <input name='reserv_id' type='hidden' value=" . $row["reserv_id"] . ">
                      ...
                      <td class='table-danger'><button type='submit' name='delete-submit' class='btn btn-danger btn-sm'>Cancel</button></td>
                        ...
                        <td class='table-danger'><a href='formedit.php?id=$row[reserv_id]'class='btn btn-danger btn-sm' >Edit</a></td>
                    </tr>
                </tbody>";
            }
        } else {
